...
typedef struct
{
    ...
    void *pvParam;
    uint32_t ui32FrequencyTicks; //Khoảng thời gian số lượng stick giữa hai lần chạy
    uint32_t ui32LastCall;  //Thời gian lần trước nó được gọi
    bool bActive;
}
tSchedulerTask;
...
//
//*****************************************************************************
extern tSchedulerTask g_psSchedulerTable[]; //Quản lý các task có các truck có kiểu như trên
