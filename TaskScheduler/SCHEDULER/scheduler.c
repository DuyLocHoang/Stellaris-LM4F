...
{
    g_ui32SchedulerTickCount++; /// systick timer trigger thÃ¬ tÄƒng 1
    if (Counter != 0) Counter--;//implement the timer
}
...
//*****************************************************************************
void
SchedulerInit(uint32_t ui32TicksPerSecond)  // nháº­n vÃ o tham sá»‘ sá»‘ stick trong 1 giÃ¢y
{
...
//*****************************************************************************
void
SchedulerRun(void)   // Duyá»‡t qua táº¥t cáº£ cÃ¡c task trong scheduler table
{
    uint32_t ui32Loop;
    tSchedulerTask *pi16Task; //Con trá»� trá»� láº§n lÆ°á»£t Ä‘áº¿n cÃ¡c task
    ...
    for(ui32Loop = 0; ui32Loop < g_ui32SchedulerNumTasks; ui32Loop++)
    {
        ...
        //
        if(pi16Task->bActive &&
           (SchedulerElapsedTicksGet(pi16Task->ui32LastCall) >= //ChÆ°Æ¡ng trÃ¬nh trá»« láº¥y cÃ¡i hiá»‡n hÃ nh trá»« lastcall. Náº¿u lá»›n hÆ¡n period thÃ¬ cháº¡y rá»“i gÃ¡n láº¡i last call báº±ng cÃ¡i Ä‘ang cháº¡y
